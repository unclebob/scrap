...
;; {:version 1, :tested-at "2026-03-16T14:25:48.280185-05:00", :module-hash "-887340469", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 2, :hash "104380728"} {:id "defn-/recommendation", :kind "defn-", :line 4, :end-line 8, :hash "1747581973"} {:id "defn-/recommendation-rule", :kind "defn-", :line 10, :end-line 12, :hash "-1618343081"} {:id "defn/local-action-rules", :kind "defn", :line 14, :end-line 44, :hash "2019773231"} {:id "defn/split-rule", :kind "defn", :line 46, :end-line 50, :hash "-1969061462"}]}
